...
import { FiHome, FiTarget, FiEye, FiDollarSign, FiTrendingUp, FiPlus, FiEdit3 } from 'react-icons/fi'
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-8 py-8 space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link
            href="/templates"
            className="bg-orange-400 hover:bg-orange-500 text-white px-6 py-2.5 rounded-lg transition-colors flex items-center space-x-2 font-semibold"
          >
          ...
          <div className="divide-y divide-gray-200">
            {recentFunnels.length > 0 ? (
              ...
              <div className="p-12 text-center">
                ...
                <Link
                  href="/templates"
                  className="bg-orange-400 hover:bg-orange-500 text-white px-6 py-2.5 rounded-lg transition-colors inline-flex items-center space-x-2 font-semibold"
                >
                  <FiPlus className="w-4 h-4" />
